...
class MovieViewWidget extends StatefulWidget {
  const MovieViewWidget({super.key});
...
class _MovieViewWidgetState extends State<MovieViewWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MovieViewModel());
  }
          ...
          body: SafeArea(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Este Filme solo se encuentra disponible en CinemApp, por favor recuerda respetar el acuerdo de confindencialidad de la aplicación y disfruta del Filme.',
